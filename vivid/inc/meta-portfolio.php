...
<ul class="meta-portfolio">
	<li><time class="entry-date updated" datetime="<?php echo get_the_date( 'c' ); ?>"><?php echo get_the_date( 'd') . '. ' . get_the_date('M'); echo bl_utilities::get_option('bl_enable_show_year') ? '. ' . get_the_date('Y') : ''; ?></time></li>
