<?php
	...
	// utilities
	define('BL_THEME_NAME', 'Vivid');
	define('BL_THEME_OPTIONS', 'vivid');
	...
	if(!function_exists('vivid_assets')){
		function vivid_assets()  { 
			...
			// add theme scripts
			wp_enqueue_script( 'blu-theme', get_template_directory_uri() . '/assets/js/theme.min.js', array('jquery'), VIVID_VERSION, true );
			wp_enqueue_script( 'bluth-plugins', get_template_directory_uri() . '/assets/js/plugins.js', array('jquery'), VIVID_VERSION, true );
			...
			wp_localize_script( 'blu-theme', 'blu', array( 
				...
				'fixed_header' => bl_utilities::get_option('bl_fixed_header'),
				// Locale
				'locale' => array(
	...
	add_action( 'wp_enqueue_scripts', 'vivid_assets' ); 									// Register this fxn and allow Wordpress to call it automatcally in the header
	add_action( 'admin_enqueue_scripts', 'vivid_admin_assets' ); 							// Register this fxn and allow Wordpress to call it automatcally in the admin header
	add_action( 'customize_controls_enqueue_scripts', 'vivid_customizer_assets' ); 	// Register this fxn and allow Wordpress to call it automatcally in the customizer admin footer
	// load language
