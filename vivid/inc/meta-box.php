<?php
	...
	function bluth_post_meta( $post )  {  
	    ...
	    $bluth_full_screen_featured_image = get_post_meta( $post->ID, 'bluth_full_screen_featured_image', true );
	    $bluth_full_screen_featured_image_height = get_post_meta( $post->ID, 'bluth_full_screen_featured_image_height', true ) ? get_post_meta( $post->ID, 'bluth_full_screen_featured_image_height', true ) : bl_utilities::get_option('bl_full_screen_featured_image_height', 400);
	    ...
	    <div class="clearfix">
		    ...
		    <fieldset class="pull-left one-four"> 
			    ...
			    <div class="cd-layout"> 
			        <input type="checkbox" id="bluth_full_screen_featured_image" name="bluth_full_screen_featured_image" <?php checked( $bluth_full_screen_featured_image, 'on' ); ?> />  
       				<label for="bluth_full_screen_featured_image"><?php _e('Full Screen Featured Image', 'bluth_admin'); ?></label>  
			    </div> 
			    <br><br>
			    <div class="cd-layout"> 
   					<label for="bluth_full_screen_featured_image_height"><?php _e('Featured Image Height', 'bluth_admin'); ?></label>  
	       			<input type="text" id="bluth_full_screen_featured_image_height" name="bluth_full_screen_featured_image_height" placeholder="<?php _e('Default: 400', 'bluth_admin'); ?>" value="<?php echo $bluth_full_screen_featured_image_height; ?>" style="margin: 10px 0; width:100%; font-size: 16px;" />  
			    </div> 
		    </fieldset> 
	    </div>
	    <?php 
	...
	{ 
	    ...
	    if( isset( $_POST['bluth_post_left_sidebar'] ) ) 
	 	...
	 	$chk = isset( $_POST['bluth_full_screen_featured_image'] ) ? 'on' : 'off';  
	    update_post_meta( $id, 'bluth_full_screen_featured_image', $chk );  
	    if( isset( $_POST['bluth_full_screen_featured_image_height'] ) ) 
	        update_post_meta( $id, 'bluth_full_screen_featured_image_height', esc_attr( strip_tags( $_POST['bluth_full_screen_featured_image_height'] ) ) );  
