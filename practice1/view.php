        ...
        <div class="panel panel-info">
            ...
            <div style="padding-top:12px" class="panel-body">
                ...
                <div style="display:<?php echo $display; ?>" class="col-sm-12">
                    <h3 style="padding-bottom: 12px; margin: 0;font-size: 16px;" class="text-center text-<?php echo $textcolor; ?>"><?php echo $message; ?></h3>
                </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 control">
                            ...
                            <div style="border-top: 1px solid #bce8f1; padding-top:15px; font-size:85%">
                                ...
                                <button type="button" class="btn btn-light" data-toggle="modal" data-target="#signupbox">Sign Up</button>
            ...
            <div class="panel-body">
                <form action="" class="form-horizontal" role="form" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="radio" name="select_gender" checked value="Male"> Male
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea type="text" class="form-control" name="user_message" placeholder=""> </textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-offset-3 col-md-9">
                            <input type="submit" name="signup_button" class="btn btn-info" value="&nbsp Submit"><i class="icon-hand-right"></i>
                        </div>
                    </div>
                </form>
            </div>
