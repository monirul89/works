 ...
 */
function radixetcltd_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Radixetcltd default saturation level.
	 *
	 * @since Radixetcltd 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'radixetcltd_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.radixetcltd-front-page) .entry-title,
...
.colors-custom .radixetcltd-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.radixetcltd-front-page .panel-content .recent-posts article,
...
.colors-custom.radixetcltd-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Radixetcltd custom colors CSS.
	 *
	 * @since Radixetcltd 1.0
	 *
	 ...
	 */
	return apply_filters( 'radixetcltd_custom_colors_css', $css, $hue, $saturation );
}
