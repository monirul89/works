<?php
/**
 * radixetcltd NUX Starter Content Class
 *
 * @package  radixetcltd
 * @since    2.0.0
 */
...
if ( ! class_exists( 'radixetcltd_NUX_Starter_Content' ) ) :

	/**
	 * The radixetcltd NUX Starter Content class
	 */
	class radixetcltd_NUX_Starter_Content {
		/**
		 * Setup class.
		 *
		 * @since 2.2.0
		...
		public function __construct() {
			...
			if ( ! isset( $_GET['sf_starter_content'] ) || 1 !== absint( $_GET['sf_starter_content'] ) ) { // WPCS: input var ok.
				add_filter( 'radixetcltd_starter_content', '__return_empty_array' );
			}
		}

		/**
		 * Remove default widgets on activation
		 * Set an option so that this is only done the first time the user activates radixetcltd.
		 *
		 * @since 2.2.0
		 * @return void
		 */
		public function remove_default_widgets() {
			if ( false === (bool) get_option( 'radixetcltd_cleared_widgets' ) && true === (bool) get_option( 'radixetcltd_nux_fresh_site' ) ) {
				update_option( 'sidebars_widgets', array( 'wp_inactive_widgets' => array() ) );
				update_option( 'radixetcltd_cleared_widgets', true );
			}
		}
		...
		public function starter_content() {
			$starter_content = array(
				'posts'       => array(
					'home'    => array(
						'post_title'   => esc_attr__( 'Welcome', 'radixetcltd' ),
						/* translators: %s: 'End Of Line' symbol */
						'post_content' => sprintf( esc_attr__( 'This is your homepage which is what most visitors will see when they first visit your shop.%sYou can change this text by editing the "Welcome" page via the "Pages" menu in your dashboard.', 'radixetcltd' ), PHP_EOL . PHP_EOL ),
						'template'     => 'template-homepage.php',
						'thumbnail'    => '{{hero-image}}',
					),
					'about'   => array(
						'post_type'    => 'page',
						'post_title'   => __( 'About', 'radixetcltd' ),
						'post_content' => __( 'You might be an artist who would like to introduce yourself and your work here or maybe you&rsquo;re a business with a mission to describe.', 'radixetcltd' ),
					),
					'contact' => array(
						'post_type'    => 'page',
						'post_title'   => __( 'Contact', 'radixetcltd' ),
						'post_content' => __( 'This is a page with some basic contact information, such as an address and phone number. You might also try a plugin to add a contact form.', 'radixetcltd' ),
					),
					'blog',
				),
				'attachments' => array(
				...
				'nav_menus'   => array(
					'primary'   => array(
						'name'  => __( 'Primary Menu', 'radixetcltd' ),
						'items' => array(
							'shop'         => array(
								'type'      => 'post_type',
								'object'    => 'page',
					...
					'secondary' => array(
						'name'  => __( 'Secondary Menu', 'radixetcltd' ),
						'items' => array(
							'my_account' => array(
								'type'      => 'post_type',
								'object'    => 'page',
					...
					'handheld'  => array(
						'name'  => __( 'Handheld Menu', 'radixetcltd' ),
						'items' => array(
							'shop' => array(
								'type'      => 'post_type',
								'object'    => 'page',
			...
			$woocommerce_pages        = radixetcltd_NUX_Admin::get_woocommerce_pages();
			...
			add_theme_support( 'starter-content', apply_filters( 'radixetcltd_starter_content', $starter_content ) );
		}
		...
		public function filter_start_content( $content, $config ) {
			...
			if ( true !== (bool) get_option( 'radixetcltd_nux_fresh_site' ) ) {
				unset( $content['posts']['about'] );
				unset( $content['posts']['contact'] );
				unset( $content['nav_menus'] );
				unset( $content['widgets'] );
		...
		public function add_product_tax() {
			...
			add_filter( 'radixetcltd_product_categories_shortcode_args', array( $this, 'filter_sf_categories' ) );
		}
		...
		/**
		 * Filter radixetcltd Product Categories shortcode.
		 *
		 * @since 2.2.0
		...
		private function _starter_content_products() {
			$accessories_name        = esc_attr__( 'Accessories', 'radixetcltd' );
			$accessories_description = esc_attr__( 'A short category description', 'radixetcltd' );

			$hoodies_name        = esc_attr__( 'Hoodies', 'radixetcltd' );
			$hoodies_description = esc_attr__( 'A short category description', 'radixetcltd' );

			$tshirts_name        = esc_attr__( 'Tshirts', 'radixetcltd' );
			$tshirts_description = esc_attr__( 'A short category description', 'radixetcltd' );

			$products = array(
				// Accessories.
				'beanie'             => array(
					'post_title'     => esc_attr__( 'Beanie', 'radixetcltd' ),
				...
				'belt'               => array(
					'post_title'     => esc_attr__( 'Belt', 'radixetcltd' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'cap'                => array(
					'post_title'     => esc_attr__( 'Cap', 'radixetcltd' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
					'thumbnail'      => '{{cap-image}}',
				...
				'sunglasses'         => array(
					'post_title'     => esc_attr__( 'Sunglasses', 'radixetcltd' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-logo'   => array(
					'post_title'     => esc_attr__( 'Hoodie with Logo', 'radixetcltd' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-pocket' => array(
					'post_title'     => esc_attr__( 'Hoodie with Pocket', 'radixetcltd' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-zipper' => array(
					'post_title'     => esc_attr__( 'Hoodie with Zipper', 'radixetcltd' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie'             => array(
					'post_title'     => esc_attr__( 'Hoodie', 'radixetcltd' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'long-sleeve-tee'    => array(
					'post_title'     => esc_attr__( 'Long Sleeve Tee', 'radixetcltd' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'polo'               => array(
					'post_title'     => esc_attr__( 'Polo', 'radixetcltd' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'tshirt'             => array(
					'post_title'     => esc_attr__( 'Tshirt', 'radixetcltd' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'vneck-tee'          => array(
					'post_title'     => esc_attr__( 'Vneck Tshirt', 'radixetcltd' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
			...
			return apply_filters( 'radixetcltd_starter_content_products', $products );
		}
		...
		private function _validate_tasks( $tasks ) {
			$valid_tasks = apply_filters( 'radixetcltd_valid_tour_tasks', array( 'homepage', 'products' ) );
...
return new radixetcltd_NUX_Starter_Content();
