<?php
/**
 * radixetcltd WooCommerce Adjacent Products Class
 *
 * @package  radixetcltd
 * @since    2.4.3
 */
...
if ( ! class_exists( 'radixetcltd_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The radixetcltd WooCommerce Adjacent Products Class
	 */
	class radixetcltd_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'radixetcltd_woocommerce_adjacent_query_args', $args ) );
