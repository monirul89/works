...
<article id="panel<?php echo $radixetcltdcounter; ?>" <?php post_class('radixetcltd-panel '); ?> >

    <?php
    if (has_post_thumbnail()) :
        $thumbnail = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'radixetcltd-featured-image');
