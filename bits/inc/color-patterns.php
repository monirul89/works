 ...
 */
function bitss_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Bitss default saturation level.
	 *
	 * @since Bitss 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'bitss_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.bitss-front-page) .entry-title,
...
.colors-custom .bitss-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.bitss-front-page .panel-content .recent-posts article,
...
.colors-custom.bitss-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Bitss custom colors CSS.
	 *
	 * @since Bitss 1.0
	 *
	 ...
	 */
	return apply_filters( 'bitss_custom_colors_css', $css, $hue, $saturation );
}
