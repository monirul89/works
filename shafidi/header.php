                ...
                <div class="navbar-top">
                    <div class="container">
                        <div class="logo navbar-left">
                            <img id="imglogo" src="<?php echo get_template_directory_uri(); ?>/images/logo.jpg" alt="logo">
                        </div>
                        <div id="logo-banner-top" class="logo-banner-top">
                            <marquee direction="down" id="marqueeheight" behavior="alternate">
