 ...
 */
function shafidi_custom_colors_css() {
    $hue = absint(get_theme_mod('colorscheme_hue', 250));

    /**
     * Filter Shafidi default saturation level.
     *
     * @since Shafidi 1.0
     *
     * @param int $saturation Color saturation level.
     */
    $saturation = absint(apply_filters('shafidi_custom_colors_saturation', 50));
...
.colors-custom.page:not(.shafidi-front-page) .entry-title,
...
.colors-custom .shafidi-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.shafidi-front-page .panel-content .recent-posts article,
...
.colors-custom.shafidi-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
    ...
    /**
     * Filters Shafidi custom colors CSS.
     *
     * @since Shafidi 1.0
     *
     ...
     */
    return apply_filters('shafidi_custom_colors_css', $css, $hue, $saturation);
}
