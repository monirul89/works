            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="thumbnail featured-product">
                        <a href="#">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/pepper.jpg" alt="">
                        </a>
                        <div class="caption">
                            <h3>Premium Niche</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="thumbnail featured-product">
                        <a href="#">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/jars.jpg" alt="">
                        </a>
                        <div class="caption">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="thumbnail featured-product">
                        <a href="#">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/pot.jpg" alt="">
                        </a>
                        <div class="caption">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="thumbnail featured-product">
                        <a href="#">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/teapot.jpg" alt="">
                        </a>
                        <div class="caption">
