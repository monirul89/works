 ...
 */
function theshoptd_custom_colors_css() {
    $hue = absint(get_theme_mod('colorscheme_hue', 250));

    /**
     * Filter The Shoptd default saturation level.
     *
     * @since The Shoptd 1.0
     *
     * @param int $saturation Color saturation level.
     */
    $saturation = absint(apply_filters('theshoptd_custom_colors_saturation', 50));
...
.colors-custom.page:not(.theshoptd-front-page) .entry-title,
...
.colors-custom .theshoptd-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.theshoptd-front-page .panel-content .recent-posts article,
...
.colors-custom.theshoptd-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
    ...
    /**
     * Filters The Shoptd custom colors CSS.
     *
     * @since The Shoptd 1.0
     *
     ...
     */
    return apply_filters('theshoptd_custom_colors_css', $css, $hue, $saturation);
}
