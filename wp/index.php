								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu multi-column columns-3">
										<div class="agile_inner_drop_nav_info">
											...
											<div class="col-sm-4 multi-gd-img">
												<img src="<?php echo get_template_directory_uri(); ?>/assets/images/nav.png" alt="">
											</div>
											<div class="clearfix"></div>
										</div>
									</ul>
				...
				<ul id="flexiselDemo1">
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/s1.jpg" alt="">
								</a>
							</div>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/s4.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/s2.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single2.html">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/s3.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/s8.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single2.html">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/s6.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/s5.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single2.html">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/s9.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						...
						<li>
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/pay7.png" alt="">
						</li>
						<li>
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/pay8.png" alt="">
						</li>
						<li>
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/pay9.png" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
